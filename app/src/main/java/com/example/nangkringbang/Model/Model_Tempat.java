...
public class Model_Tempat {
    ...
    private String tempat_email, tempat_lokasi, tempat_nama, tempat_owner, tempat_status, tempat_telp;
    private int tempat_buka, tempat_tutup;
    private List<String> tempat_img;

    public Model_Tempat () {}

    public Model_Tempat(String tempat_email, String tempat_lokasi, String tempat_nama, String tempat_owner, String tempat_status,String tempat_telp, int tempat_buka, int tempat_tutup, List<String> tempat_img) {
    ...
    public int getTempat_buka() {
        return tempat_buka;
    }

    public void setTempat_buka(int tempat_buka) {
        this.tempat_buka = tempat_buka;
    }

    public int getTempat_tutup() {
        return tempat_tutup;
    }

    public void setTempat_tutup(int tempat_tutup) {
        this.tempat_tutup = tempat_tutup;
    }
